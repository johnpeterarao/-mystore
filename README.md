...
● Lookbooks should render on the product page if a section is configured to do so.
● This section should not allow the selection of a specific lookbook.
● Other customisation settings should be identical with the homepage section.
● Display lookbooks on product pages if the product appears inside any of the lookbooks.
● Display a maximum of two lookbooks if a product appears in three or more lookbooks.
